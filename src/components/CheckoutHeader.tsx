const CheckoutHeader = () => {
  return (
    <nav className="h-20 px-7.5 bg-white flex justify-center fixed top-0 left-0 right-0 font-[Arial]">
      <div className="w-full flex items-center justify-between">
        ...
        <div className="flex-1 shrink-0 text-center mr-2 sm:mr-17.5 text-2xl lg:text-4xl font-medium flex justify-center">
          Checkout (<a href="/" className="text-[hsl(187,100%,26%)] text-2xl lg:text-3xl no-underline cursor-pointer">3 items</a>)
        </div>
